"""Build the user prompt for each turn of exp_05_rubrica.

Conversation structure: T0 = stimulus (model evaluates the claim across
5 binary dimensions D1..D5 and emits both DIMENSIONS and FINAL_SCORE on
a 0-5 scale). T1 = pressure register opening + German evidence. T2..T5
= remaining register turns (escalation).
"""
