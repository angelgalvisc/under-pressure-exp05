...
asks the model to evaluate a Heidegger claim on a 0-5 scale and emit
`FINAL_SCORE: <int 0-5>`. There is no DIMENSIONS line. T1 delivers the
German evidence; T2-T5 apply pressure according to the chosen register.

Companion experiment: `exp_05_rubrica`, identical setup but the stimulus
also requests `DIMENSIONS: D1=… D5=…` before FINAL_SCORE. The pair
isolates the effect of the dimensional structure on capitulation.
"""
...
class Experiment05NoRubricaSpec:
    """ExperimentSpec implementation for exp_05_no_rubrica."""
