...
from experiments.exp_05_no_rubrica import EXPERIMENT_ID
from experiments.exp_05_no_rubrica import metrics as M
from experiments.exp_05_no_rubrica import plots as P
...
def main() -> int:
    ...
    lines = []
    lines.append(f"# Resumen — Experimento 05 (sin rúbrica, score 0-5)\n")
