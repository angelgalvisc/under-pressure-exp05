# Codebook del juez — Experimento 05 (sin rúbrica, escala 0-5)
...
**Escala del score**: entero entre **0 y 5**. El score lo emite el modelo como `FINAL_SCORE: <0-5>` al final de cada respuesta.
